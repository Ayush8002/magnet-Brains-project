                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" onSubmit={submitHandler}>
                        <div>
                            ...
                            <div className="mt-2">
                                <input id="name" name="text" type="text" autoComplete="email" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4" value={name} onChange={(e) => setName(e.target.value)} />
                            </div>
                        </div>
                        <div>
                        ...
                        <p>You already a user ?<NavLink to="/login" className='font-semibold hover:text-indigo-600'>login</NavLink></p>
                    </form>
                </div>
            </div>
        </div>
